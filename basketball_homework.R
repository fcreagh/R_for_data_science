...
# <put your code here>
#
free_throws <- rbind(KobeBryant_FT, JoeJohnson_FT,
...
free_throw_attempts <- rbind(KobeBryant_FTA, JoeJohnson_FTA,
...
# Plots
my_plot(free_throw_attempts / Games)

my_plot(free_throws / free_throw_attempts)

my_plot((Points - free_throws) / FieldGoals)